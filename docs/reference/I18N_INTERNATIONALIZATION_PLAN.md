...
> WP33–WP36 (public taşıma — planlandı).
...
| Sıra | WP | İş |
|------|----|----|
| 1 | **WP33** | **Localized public shell** — `[locale]` için next-intl nav/footer/LanguageSwitcher; admin shell'inden ayrık |
| 2 | **WP34** | **Sayfa-başına taşıma** — §5 reçetesiyle, ağırlık sırası: discover → marketplace → organizations → learning-paths → events → home (en ağır en sona) |
| 3 | **WP35** | **Uluslararası SEO mekaniği** — locale'li `sitemap.ts`, `hreflang`, SSR `<html lang>`, canonical, eski-URL 301 standardı |
| 4 | **WP36** | **İçerik i18n** — organizatör verisi (etkinlik adı/açıklama, e-posta, sertifika) `Event.config.i18n` JSONB + public okuma yolları + cache anahtarına locale |
...
---
_Son güncelleme: 2026-06-30 · Next 15.5 App Router · 9 katalog + altyapı hazır (branch); public taşıma WP33–WP36 ile planlandı._
