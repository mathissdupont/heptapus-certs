# WP33 — Localized Public Shell (i18n)
...
This is the prerequisite for every page migration (WP34): without it, a `/de` page would
...
content (WP34); SEO mechanics (WP35).
...
Upstream: WP18 (catalogs + infra). Downstream: WP34. See ADR-0021.
