...
class Settings(BaseSettings):
    ...
    health_probe_timeout_seconds: float = Field(default=2.0, ge=0.1, le=10, alias="HEALTH_PROBE_TIMEOUT_SECONDS")
    health_heartbeat_ttl_seconds: int = Field(default=60, ge=15, le=600, alias="HEALTH_HEARTBEAT_TTL_SECONDS")
    health_require_presentation_worker: bool = Field(default=False, alias="HEALTH_REQUIRE_PRESENTATION_WORKER")
    health_require_scheduler: bool = Field(default=False, alias="HEALTH_REQUIRE_SCHEDULER")
