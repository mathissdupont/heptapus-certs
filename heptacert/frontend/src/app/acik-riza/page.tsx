...
export default function AcikRizaPage() {
  ...
  const sections = isTr
    ? [
        ...
        ["8. Otomatik İşleme ve Profilleme (CRM / Lead Scoring)", "HeptaCert platformunu kullanan organizasyon yöneticileri, etkinlik katılımcılarına ait verileri kurumsal CRM modülü aracılığıyla işleyebilir. Bu kapsamda yaşam döngüsü durumu (lifecycle status), öncelik skoru, lead skoru (0-100 arası), etiketler ve müşteri notları gibi profilleme işlemleri yapılabilir. Söz konusu veriler yalnızca organizasyon yöneticisi tarafından görülebilir; üçüncü taraflarla paylaşılmaz. Profilleme işlemlerine KVKK md. 11 kapsamında itiraz etme ve bu verilerin silinmesini talep etme hakkınız mevcuttur. Profilleme sonuçları doğrudan hukuki sonuç doğuran veya sizi önemli ölçüde etkileyen kararlar için tek başına dayanak alınmaz. Talep ve itirazlar için contact@heptapusgroup.com adresine başvurabilirsiniz."],
        ["9. İlgili Metinler", "Kişisel verilerinizin işlenmesine ilişkin ayrıntılı bilgiye KVKK Aydınlatma Metni ve Gizlilik Politikası üzerinden ulaşabilirsiniz."],
      ]
    : [
        ...
        ["8. Automated Processing and Profiling (CRM / Lead Scoring)", "Organization administrators using the HeptaCert platform may process event participant data through the organization CRM module. In this context, profiling operations such as lifecycle status, priority score, lead score (0–100), tags, and customer notes may be applied. Such data is only visible to the organization administrator and is not shared with third parties. You have the right to object to profiling and request deletion of this data under applicable data protection law. Profiling outcomes are not used alone as a basis for decisions that produce legal effects or that significantly affect you. To submit requests or objections, please contact contact@heptapusgroup.com."],
        ["9. Related Texts", "You can access detailed information regarding the processing of your personal data through the Privacy Notice and Privacy Policy."],
      ];
    ...
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="space-y-8 rounded-2xl border border-gray-100 bg-white p-8 shadow-card md:p-12">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500">{isTr ? "Son güncelleme: 4 Haziran 2026" : "Last updated: June 4, 2026"}</p>
        </div>
