...
import {
  ChevronLeft, Send, AlertCircle, Loader2, CheckCircle2,
  Clock, X, Eye, Plus, Mail, User, BarChart3, TrendingUp, Settings, CalendarDays,
  QrCode, UserCheck, LockKeyhole, Target,
} from "lucide-react";
