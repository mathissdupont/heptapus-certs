...
export default function GizlilikPage() {
  ...
  const sections = isTr
    ...
    : [
        ...
        ["5. User and Organizer Responsibility", "Users and event organizers are responsible for legal compliance of uploaded data, required notices/consents, and third-party rights compliance. Preparing and evidencing event-specific notices and consents is primarily the organizer's responsibility."],
