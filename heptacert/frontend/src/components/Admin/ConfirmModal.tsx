          ...
          >
            ...
            <div className="flex flex-col-reverse gap-2 sm:flex-row sm:justify-end sm:gap-1.5">
              <button
                onClick={onCancel}
                disabled={loading}
                className="w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-xs font-semibold text-gray-700 shadow-sm transition hover:bg-gray-50 active:scale-98 disabled:opacity-50 sm:w-auto"
              >
                {cancelLabel}
              </button>
              <button
                onClick={onConfirm}
                disabled={loading}
                className={`w-full inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-xs font-semibold text-white shadow-sm transition active:scale-98 disabled:opacity-40 sm:w-auto ${
                  danger 
