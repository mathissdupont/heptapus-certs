      ...
      {open && typeof document !== "undefined" && createPortal(
        ...
        >
          <div className="grid grid-cols-[1fr_auto_1fr] items-start gap-2.5">
            {/* Saat Sütunu */}
            <div>
              <p className="mb-2 text-11 font-bold uppercase tracking-wider text-surface-400">Saat</p>
            ...
            {/* Dakika Sütunu */}
            <div>
              <p className="mb-2 text-11 font-bold uppercase tracking-wider text-surface-400">Dakika</p>
          ...
          <div className="mt-4 flex items-center justify-between border-t border-surface-100 pt-3">
            ...
            <button 
              ...
              className="rounded-xl border border-surface-200 bg-white px-3.5 py-1.5 text-xs font-semibold text-surface-800 shadow-sm transition hover:bg-surface-50 hover:text-surface-900 active:scale-95"
            >
              Tamam
            </button>
          </div>
