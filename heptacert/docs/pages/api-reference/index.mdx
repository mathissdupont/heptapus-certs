...
Etkinliklerden bağımsız kişi/şirket katmanı (bkz. [Temel Kavramlar](/concepts#crm-katmanı)).
...
Payload formatı, imza doğrulama ve yeniden deneme politikası için [Webhooks](/webhooks) sayfasına bakın.
